...
public class Main {
    ...
    private static void criarPersonagem() {
        ...
        try {
            ...
            System.out.println("\n✗ Erro ao salvar personagem: " + e.getMessage());
        }
    }
    ...
    private static void listarPersonagens() {
        ...
        try {
            ...
            System.out.println("\n✗ Erro ao listar personagens: " + e.getMessage());
        }
    }
    ...
    private static void buscarPersonagem() {
        ...
        try {
            ...
            System.out.println("\n✗ Erro ao buscar personagem: " + e.getMessage());
        }
    }
    ...
    private static void exibirFichaCompleta() {
        ...
        try {
            ...
            System.out.println("\n✗ Erro ao exibir ficha: " + e.getMessage());
        }
    }
    ...
    private static void testarCombate() {
        ...
        try {
            ...
            System.out.println("\n✗ Erro ao testar combate: " + e.getMessage());
        } catch (NumberFormatException e) {
    ...
    private static void carregarExemplos() {
        ...
        try {
            ...
            System.out.println("\n✗ Erro ao carregar exemplos: " + e.getMessage());
        }
    }
}